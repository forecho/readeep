                        ...
                        <div class="tabsContent" style="height:720px;margin: 0 auto;">
                                ...
                                <div>
                                        <dl>
                                                <dt>邮件模板 </dt>
                                                <dd>   
                                                        <select id="selTemplate" onchange="changeTemplate()" name="MailTemplates[template_id]">
                                                                <?php
                                        ...
                                        <dl class="nowrap">
                                                <dt><?php echo $form->labelEx($firstModel, 'template_subject'); ?></dt>
                                                <dd>
                                                        <?php
                                                                echo $form->textfield($firstModel, 'template_subject');
                                                        ?>
                                                </dd>    

                                        </dl>
                                        <dl class="nowrap">
                                                <dt><?php echo $form->labelEx($firstModel, 'is_html'); ?></dt>
                                                <dd class="yii_label">

                                                        <?php
                                                                echo $form->radioButtonList($firstModel, 'is_html', array(1 => '源码显示', 0 => '正常显示'), array('separator' => '&nbsp;', 'style'     => 'float:none;'), array(''));
                                                        ?>
                                                </dd>    
                                        </dl>
                                        <div class="unit">
                                                <dl class="nowrap">
                                                        <dt><?php echo $form->labelEx($firstModel, 'template_content'); ?></dt>
                                                        <dd>
                                                                <textarea class="editor" id="MailTemplates_template_content" name="MailTemplates[template_content]" rows="15" cols="100" upLinkUrl="upload.php" upLinkExt="zip,rar,txt" 
                                                                        ...
                                                                        <?php echo $firstModel->template_content;?>
                                                                </textarea>
                                                        </dd>
                                                </dl>  
                                </div>
