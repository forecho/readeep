...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'mail_account'); ?>
		<?php echo $form->textField($model,'mail_account',array('size'=>60,'maxlength'=>60)); ?>
		<?php echo $form->error($model,'mail_account'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'mail_password'); ?>
		<?php echo $form->textField($model,'mail_password',array('size'=>60,'maxlength'=>60)); ?>
		<?php echo $form->error($model,'mail_password'); ?>
	</div>
