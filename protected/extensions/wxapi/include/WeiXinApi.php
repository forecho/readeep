<?php
require(dirname(__FILE__). "/LeaWeiXinClient.php");
...
class WeiXinApi
{
	...
	public function __construct($config) {
		...
		fopen($config['cookiePath'], 'w+');
		fopen($config['webTokenPath'], 'w+');
	...
	public function getLatestMsgByCreateTimeAndContent($createTime, $content) {
		...
		if (!$lMsgs) {
			$this->getLatestMsgByCreateTimeAndContent($createTime, $content);
		} else {
